...
def get_op_and_shape(input_shape, params, framework, shape_only=False):
    ...
    if framework == 'TensorFlow':
        ...
        if params.__contains__('momentum'):
            ...
            momentum = 0.1
        return torch.nn.BatchNorm1d(num_features, eps, momentum, affine, track_running_stats), input_shape
        ...
        if params.__contains__('momentum'):
            ...
            momentum = 0.1
        return jittor.nn.BatchNorm1d(num_features, eps, momentum, affine, track_running_stats), input_shape
    else:
